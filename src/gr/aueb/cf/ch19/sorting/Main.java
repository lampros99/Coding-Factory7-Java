...
public class Main {
    public static void main(String[] args) {
        List<Product> products1 = List.of(new Product("", 12.5, 10), // Partially Immutable list
                new Product("", 12.5, 10));

        List<Product> products2 = List.of(new Product("", 12.5, 10), // Partially Immutable list
                new Product("", 12.5, 10));
